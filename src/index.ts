...
export function vx(component: Component): VxFunc {
  const [base, variants] = mergeProps(component.base, component.variants || {}, component.extends);

  const defaultVariants = component.extends ? { ...component.extends.defaultVariants, ...component.defaultVariants } : component.defaultVariants || {};

  const fn: VxFunc = (variantOverrides: { [key: string]: string } = {}) => {
